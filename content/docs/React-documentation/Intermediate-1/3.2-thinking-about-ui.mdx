...
## <h1 className="bg-gradient-to-r from-blue-500 to-purple-500 inline-block text-transparent bg-clip-text text-4xl pt-2"> ইউ আই-কে ডিক্লারেটিভলি ভাবা (Thinking about UI Declaratively)</h1>
