...
## <h1 className="bg-gradient-to-r from-blue-500 to-purple-500 inline-block text-transparent bg-clip-text text-4xl pt-2">Props কি?</h1>
...
## <h1 className="bg-gradient-to-r from-blue-500 to-purple-500 inline-block text-transparent bg-clip-text text-4xl pt-2">Props পাঠানোর উদাহরণ</h1>
...
## <h1 className="bg-gradient-to-r from-blue-500 to-purple-500 inline-block text-transparent bg-clip-text text-4xl pt-2">Props পাঠানোর এবং রিসিভ করার পদ্ধতি</h1>
...
## <h1 className="bg-gradient-to-r from-blue-500 to-purple-500 inline-block text-transparent bg-clip-text text-4xl pt-2">Props ডিকন্সট্রাকচারিং পদ্ধতিতে রিসিভ করা</h1>
...
## <h1 className="bg-gradient-to-r from-blue-500 to-purple-500 inline-block text-transparent bg-clip-text text-4xl pt-2">JSX স্প্রেড সিনট্যাক্সের মাধ্যমে Props ফরওয়ার্ড করা</h1>
...
## <h1 className="bg-gradient-to-r from-blue-500 to-purple-500 inline-block text-transparent bg-clip-text text-4xl pt-2">Children Props হিসেবে JSX বা Component পাঠানো</h1>
...
## <h1 className="bg-gradient-to-r from-blue-500 to-purple-500 inline-block text-transparent bg-clip-text text-4xl pt-2">Props are Immutable: কেন?</h1>
