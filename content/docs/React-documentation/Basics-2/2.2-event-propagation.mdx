...
## <h1 className="bg-gradient-to-r from-blue-500 to-purple-500 inline-block text-transparent bg-clip-text text-4xl pt-2">ইভেন্ট ডেলিগেশন (event deligation) কি ?</h1>
...
## <h1 className="bg-gradient-to-r from-blue-500 to-purple-500 inline-block text-transparent bg-clip-text text-4xl pt-2">ইভেন্ট প্রপাগেশন (event propagation) কি ?</h1>
...
## <h1 className="bg-gradient-to-r from-blue-500 to-purple-500 inline-block text-transparent bg-clip-text text-4xl pt-2"> ইভেন্ট বাবলিং (Bubbling) কি ?</h1>
...
## <h1 className="bg-gradient-to-r from-blue-500 to-purple-500 inline-block text-transparent bg-clip-text text-4xl pt-2"> Propagation in React</h1>
